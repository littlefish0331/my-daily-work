...
- google calender
- 改+訂高鐵車票
  - 改12/16(三)台北新竹回程改地點 OK
  - 改12/21(一)台北新竹回程改地點 OK
  - 訂12/14(四)台北新竹，如果沒有要和女友吃飯就先訂 OK
  - 訂12/29(二)台北新竹 OK
  - 訂12/24(四)台北新竹的票取消
- Email NCHC
- Email yahoo
...
- google calender
- 交辦怡瑄事宜 OK
  - 找找看好用的 bot desinger prototype 工具
    - LINE bot designer: 學習聊天機器人的各種訊息型式 + 簡單實作一個prototype(maybe教學分享)
  - 確認角色定位-dashboard，會寫 python，有想要往程式多一點
  - Git 安裝與初步概念教學 https://w3c.hexschool.com/git/cfdbd310
  - 下午國O部開會不可以帶她，時間到了可以自己下班XD
- AWS book 第一章第七節
- 訂+改高鐵票:
  - 訂12/29(二)台北新竹
- 詢問 聊天機器人分享(Julia Lin) 的 PPT ... get it
- KVGH 影片上傳與公告
- 台電工作人員，索取素材溝通
